...
internal fun MainActivity.showProviderSettings() {
    ...
    dialog.setOnDismissListener {
        ...
        if (!hasProviderEnabled() && !hasPlugin) {
            ...
            if (showingHome) selectHome() else if (showingFavorites) selectFavorites() else if (showingDiscover) selectDiscover() else if (showingDownloads) selectDownloads() else selectTab(activeTab)
        }
    }
