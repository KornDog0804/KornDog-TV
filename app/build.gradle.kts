...
android {
    ...
    defaultConfig {
        ...
        // GitHub Actions keeps using its normal run number.
        //
        // Local/Termux release builds need a versionCode newer than any
        // previously installed CI build, otherwise Android rejects them as
        // INSTALL_FAILED_VERSION_DOWNGRADE. Use epoch minutes locally so each
        // build naturally moves forward without manually editing Gradle.
        val localBuildNumber =
            (System.currentTimeMillis() / 60_000L)
                .coerceAtMost(1_700_000_000L)
                .toInt()
